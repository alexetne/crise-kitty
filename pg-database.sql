...
-- 2026-04-23: organization-adjustable inactivity timeout for authenticated sessions.
ALTER TABLE "organizations" ADD COLUMN IF NOT EXISTS "session_timeout_minutes" int NOT NULL DEFAULT 30;

-- 2026-04-23: organization hierarchy, white-label branding and active organization session context.
